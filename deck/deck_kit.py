...
failed, amber = built but unproven, violet = roadmap.
    ...
    python deck_kit.py      # the earlier 24-slide detailed deck

Shared drawing kit (tokens, chrome, node/arrow/table helpers). The compact
submission deck in build_deck.py imports everything from here.
"""
...
def build(path=None):
    path = path or os.path.join(os.path.dirname(os.path.abspath(__file__)),
                                "Vault_PocketRAG_Deck_detailed.pptx")
    prs = Presentation()
